...
**推荐方式**：直接在 PyCharm IDE 中运行 `main.py` ⭐**自动生成可视化图表**

### 快速开始（3步）：

1. **打开项目**：在 PyCharm 中打开 `pgg_reflective_demo` 文件夹
2. **安装依赖**：`pip install -r requirements.txt`
3. **运行**：右键点击 `main.py` → `Run 'main'`
...
**推荐参数**（已优化）：
```python
r = 2.5        # 倍增系数（2.0-3.0为宜）
tau = 0.2      # 规范阈值（0.15-0.3为宜）
fine_F = 1.5   # 初始罚金（1.0-2.0为宜）
```
...
- [在 PyCharm 中运行](#在-pycharm-中运行最简单)
- [项目简介](#项目简介)
- [核心特性](#核心特性)
- [安装](#安装)
- [快速开始](#快速开始)
